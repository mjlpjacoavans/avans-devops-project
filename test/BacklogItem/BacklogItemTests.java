...
public class BacklogItemTests {
    ...
    //Backlogitem split in activities done fail
    @Test
    public void BACKLOGITEM_TEST_2_SplitInActivitiesFail(){
        //Arrange
        ProductOwnerUser productOwnerUser = new ProductOwnerUser("Test", "test@test.nl", "testid");
        Project project = new Project("TestProject", productOwnerUser);
        ProductBacklog productBacklog = new ProductBacklog(project);
    ...
    @Test
    public void BACKLOGITEM_TEST_5_AddDeveloperSucces(){

    }

    //Backlogitem add developer in done fail
    @Test
    public void BACKLOGITEM_TEST_6_AddDeveloperFail(){
    ...
    @Test
    public void BACKLOGITEM_TEST_9_SetStateToDoingWithDevAssignPass(){

    }

    //BacklogItem set state to doing with no dev assigned fail
    @Test
    public void BACKLOGITEM_TEST_10_SetStateToDoingWithNoDevAssignFail(){
    ...
    @Test
    public void BACKLOGITEM_TEST_13_SetStateToReadyForTestingPass(){

    }

    //Backlog item add tester in ready for testing pass
    @Test
    public void BACKLOGITEM_TEST_14_AddTesterPass(){

    }

    //BacklogItem add tester in done fail
    @Test
    public void BACKLOGITEM_TEST_15_AddTesterFail(){

    }

    //backlogItem set state to testing in ready for testing pass
    @Test
    public void BACKLOGITEM_TEST_16_SetStateToTestingPass(){
    ...
    @Test
    public void BACKLOGITEM_TEST_19_SetDefinitionPass(){

    }

    //BacklogItem set definitionmet met ongeldige lead dev fail
    @Test
    public void BACKLOGITEM_TEST_20_SetDefinitionFail(){

    }

    //Backlogitem set state to done pass
    @Test
    public void BACKLOGITEM_TEST_21_SetStateToDonePass(){
